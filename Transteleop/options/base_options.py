...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--log_path', type=str, default='./log', help='logs are saved here')

        # model parameters
        parser.add_argument('--model', type=str, default='pix2pix', help='chooses which model to use. [ jointpost | pix2pix ]')
        ...
        parser.add_argument('--fc_embedding', action='store_true', help='use fc_embedding for the generator')
        parser.add_argument('--g_embed', type=int, default=32, help='# embedding size of fc_embedding Gnet')
        ...
        parser.add_argument('--preprocess', type=str, default='rotate_jitter', help='scaling and cropping of images at load time [resize_and_crop | crop | scale_width | scale_width_and_crop | none]')
        ...
        parser.add_argument('--stn', action='store_true', help='add spatial transformation network before E and G')
        parser.add_argument('--demo', action='store_true', help='only return joints angle at demo mode')
